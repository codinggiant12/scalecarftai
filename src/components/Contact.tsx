...
const serviceTypes = ["AI Development", "Consulting", "Automation", "Other"];
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="bg-[#0f172a]/40 backdrop-blur-2xl border border-white/10 rounded-[2rem] md:rounded-[3.5rem] p-6 sm:p-10 md:p-16 shadow-2xl">
          ...
          >
            ...
            <div className="flex overflow-x-auto pb-2 md:pb-0 md:flex-wrap justify-start md:justify-center gap-2 md:gap-3 mb-6 md:mb-10 no-scrollbar">
              {serviceTypes.map((type) => (
                <button
                  key={type}
                  type="button"
                  onClick={() => setSelectedService(type)}
                  className={`whitespace-nowrap px-4 py-2 md:px-5 md:py-2 rounded-full text-[9px] md:text-[10px] font-black uppercase tracking-widest transition-all border ${
